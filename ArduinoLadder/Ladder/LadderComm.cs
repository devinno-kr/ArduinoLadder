...
namespace ArduinoLadder.Ladder
{
    ...
    public class LcModbusRtuSlave : ILadderComm
    {
        ...
        public int P_BaseAddress { get; set; } = LadderComm.Default_P_BaseAddress;
        public int M_BaseAddress { get; set; } = LadderComm.Default_M_BaseAddress;
        public int T_BaseAddress { get; set; } = LadderComm.Default_T_BaseAddress;
        public int C_BaseAddress { get; set; } = LadderComm.Default_C_BaseAddress;
        public int D_BaseAddress { get; set; } = LadderComm.Default_D_BaseAddress;
        public int WP_BaseAddress { get; set; } = LadderComm.Default_WP_BaseAddress;
        public int WM_BaseAddress { get; set; } = LadderComm.Default_WM_BaseAddress;
    }
    #endregion
