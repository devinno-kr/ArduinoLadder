...
{
    public partial class FormInputBox : DvForm
    {
        #region Properties
        ...
        public T? ShowInputBox<T>(string Title, T value, Dictionary<string, InputBoxInfo> infos) where T : class
        {
            ...
            this.Height = Math.Max(MinHeight, TitleHeight + 10 + (RowCount * (ItemHeight + 6)) + 10 + 36 + 10 + bWinH);
            #endregion
            #region Layout
        ...
        private void show(string Title, Control c, Action actReturn)
        {
            ...
            this.Width = Math.Max(MinWidth, 10 + (ColumnCount * (ItemWidth + 6)) + 10);
            this.Height = Math.Max(MinHeight, TitleHeight + 10 + (ItemHeight + 6) + 10 + 36 + 10 + bWinH);
            #endregion
            #region Layout
            tpnl.RowStyles.Clear();
            tpnl.ColumnStyles.Clear();
