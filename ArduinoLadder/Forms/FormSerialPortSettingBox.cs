...
{
    public partial class FormSerialPortSettingBox : DvForm
    {
        #region Properties
        ...
        #region Constructor
        public FormSerialPortSettingBox()
        {
            InitializeComponent();
        ...
        public SerialPortSetting ShowSerialPortSetting(SerialPortSetting v = null)
        {
            ...
            this.Size = new Size(300, TitleHeight + pad.Top + (39 * 5 + 10) + tpnlBox.Height + pad.Bottom + bWinH);
            #endregion
            #region UI
            tpnl.SuspendLayout();
        ...
        public SerialPortSetting ShowSimpleSerialPortSetting(SerialPortSetting v = null)
        {
            ...
            #region Size
            var pad = dvContainer1.Padding;
            this.Size = new Size(300, TitleHeight + pad.Top + (39 * 2 + 10) + tpnlBox.Height + pad.Bottom + bWinH);
            #endregion
            #region UI
            tpnl.SuspendLayout();
