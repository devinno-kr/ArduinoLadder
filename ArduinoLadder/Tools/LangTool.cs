...
namespace ArduinoLadder.Tools
{
    public class LangTool
    {
        ...
        public static string AppTitle
        {
            get
            {
                if (lang == Lang.KO) return "아두이노 레더 에디터";
                else if (lang == Lang.EN) return "Arduino Ladder Editor";
                else return "";
            }
        }
        #endregion
        ...
        public static string PinNumber
        {
            get
            {
                if (lang == Lang.KO) return "핀 번호";
                else if (lang == Lang.EN) return "Pin Number";
                else return "";
            }
        }
        #endregion
        ...
        #endregion
        #region PortSetting
        public static string PortSetting
        {
            get
            {
                if (lang == Lang.KO) return "포트 설정";
                else if (lang == Lang.EN) return "Port Setting";
                else return "";
            }
        }
        #endregion
        ...
        public static string MainCode
        {
            get
            {
                if (lang == Lang.KO) return "메인 코드";
                else if (lang == Lang.EN) return "Main Code";
                else return "";
            }
        }
        #endregion
        ...
        public static string Hardware
        {
            get
            {
                if (lang == Lang.KO) return "하드웨어";
                else if (lang == Lang.EN) return "Hardware";
                else return "";
            }
        }
        #endregion
        #region HardwareList
        public static string HardwareList
        {
            get
            {
                if (lang == Lang.KO) return "하드웨어 목록";
                else if (lang == Lang.EN) return "Hardware List";
                else return "";
            }
        }
        #endregion
        #region HardwareInputFormat
        public static string HardwareInputFormat
        {
            get
            {
                if (lang == Lang.KO) return "※입력 형식 : '[모드]  [핀]  [메모리]'\r\n※입력 예시 : 'OUT  3  P0', 'IN  4  P10', 'AD  0  D10', 'DA  12  D20'";
                else if (lang == Lang.EN) return "※Input format : '[mode]  [pin]  [memory]'\r\n※Input example : 'OUT  3  P0', 'IN  4  P10', 'AD  0  D10', 'DA  12  D20'";
                else return "";
            }
        }
        #endregion
        ...
        public static string SketchPath
        {
            get
            {
                if (lang == Lang.KO) return "스케치 경로";
                else if (lang == Lang.EN) return "Sketch Path";
                else return "";
            }
        }
        #endregion
        ...
        public static string DebugPort
        {
            get
            {
                if (lang == Lang.KO) return "디버그 포트";
                else if (lang == Lang.EN) return "Debug Port";
                else return "";
            }
        }
        #endregion
        #region ArduinoFolder
        public const string ArduinoFolderK = "아두이노 폴더";
        public const string ArduinoFolderE = "Arduino Folder";
        public static string ArduinoFolder
        {
            get
            {
                if (lang == Lang.KO) return ArduinoFolderK;
                else if (lang == Lang.EN) return ArduinoFolderE;
                else return "";
            }
        }
        #endregion
